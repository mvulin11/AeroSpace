...
%{window-x}:: Number. Window frame top-left x coordinate (fork extension)
%{window-y}:: Number. Window frame top-left y coordinate (fork extension)
%{window-width}:: Number. Window frame width (fork extension)
%{window-height}:: Number. Window frame height (fork extension)
%{window-frame}:: String. Window frame in X11 geometry convention `WxH+X+Y` (fork extension)
